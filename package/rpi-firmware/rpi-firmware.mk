...
RPI_FIRMWARE_JAILHOUSE_DTBO_FILE = $(call qstrip,$(BR2_PACKAGE_RPI_FIRMWARE_JAILHOUSE_DTBO_FILE))
ifneq ($(RPI_FIRMWARE_JAILHOUSE_DTBO_FILE),)
define RPI_FIRMWARE_INSTALL_JAILHOUSE_DTBO
	$(INSTALL) -D -m 0644 $(RPI_FIRMWARE_JAILHOUSE_DTBO_FILE) \
		$(BINARIES_DIR)/rpi-firmware/overlays/jailhouse-overlay.dtbo
endef
endif

RPI_FIRMWARE_ARM_STUB_FILE = $(call qstrip,$(BR2_PACKAGE_RPI_FIRMWARE_ARM_STUB_FILE))
ifneq ($(RPI_FIRMWARE_ARM_STUB_FILE),)
define RPI_FIRMWARE_INSTALL_ARM_STUB
	$(INSTALL) -D -m 0644 $(RPI_FIRMWARE_ARM_STUB_FILE) \
		$(BINARIES_DIR)/rpi-firmware/bl31.bin
endef
endif
...
define RPI_FIRMWARE_INSTALL_IMAGES_CMDS
	...
	$(RPI_FIRMWARE_INSTALL_JAILHOUSE_DTBO)
	$(RPI_FIRMWARE_INSTALL_ARM_STUB)
